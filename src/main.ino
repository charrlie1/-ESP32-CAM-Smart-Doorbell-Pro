...
const unsigned char icon_user[] PROGMEM = {
  0x03, 0xc0, 0x0f, 0xf0, 0x1c, 0x38, 0x18, 0x18, 0x18, 0x18, 0x1c, 0x38,
  0x0f, 0xf0, 0x07, 0xe0, 0x3f, 0xfc, 0x7f, 0xfe, 0xff, 0xff, 0xff, 0xff,
...
void updateDisplay() {
  ...
  if (currentState == STANDBY) {
    if (customMessage != "") {
      ...
      display.drawBitmap(56, 22, icon_lock, 16, 16, WHITE);
      display.setTextSize(2);
      ...
      display.drawBitmap(0, 58, icon_user, 8, 8, WHITE);
      display.setCursor(10, 58);
      display.print(lastUnlockedBy.substring(0, 9));

      display.setCursor(80, 58);
      display.print("@");
      display.print(lastEntryTime);
    }
  }
